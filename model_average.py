...
model_list = [
              #'20181231111850_size512_B16_lr0.0001_se_resnext50_bce_ext_over_best',
              #'20181231111850_size512_B16_lr0.0001_se_resnext50_bce_ext_over_snap1',
              #'20181231111850_size512_B16_lr0.0001_se_resnext50_bce_ext_over_snap2',
              #'20181231111850_size512_B16_lr0.0001_se_resnext50_bce_ext_over_snap3',
              '20190103093253_size512_B10_lr5e-05_se_resnext50_focal_ext_over_best_fold0',
              '20190103093253_size512_B10_lr5e-05_se_resnext50_focal_ext_over_best_fold1'
             ]
...
sum_pred = 0
for learner in tqdm(learner_list):
    preds,y = learner.TTA(n_aug=n_aug)
    preds = np.stack(preds, axis=-1)
    preds = utils_pytorch.sigmoid_np(preds)
    sum_pred += preds.mean(axis=-1)
pred = sum_pred / len(learner_list)
...
for learner in tqdm(learner_list):
    ...
    sum_pred_t += preds_t.mean(axis=-1) #max works better for F1 macro score
pred_t = sum_pred_t / len(learner_list)
